 ...
 * @author Yvan
 */
public class AviaoMilitar extends Aviao{
    protected int municao;
    protected int qtdBombas;
    protected boolean sobAtaque;
    
    public AviaoMilitar(int numPassag, String modelo, int altitude, float horasVoo, 
    ...
    public AviaoMilitar(int municao, int qtdBombas, boolean sobAtaque){
        setMunicao(municao);
        setBombas(qtdBombas);
        setSobAtaque(sobAtaque);
    }
